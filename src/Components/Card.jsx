...
const Card = ({price="30"}) => {
  ...
  return (
    <div>
       <div class="flex font-sans mt-4">
  <div class="flex-none w-56 relative">
    <img src="https://images.pexels.com/photos/17991697/pexels-photo-17991697/free-photo-of-a-boy-is-playing-with-a-toy-train-on-a-street.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" class="absolute inset-0 w-full h-full object-cover rounded-lg" loading="lazy" />
  </div>
  <form class="flex-auto p-6">
    ...
    <div class="flex space-x-4 mb-5 text-sm font-medium">
      <div class="flex-auto flex space-x-4">
        ...
        <button class="h-10 px-6 font-semibold rounded-full border border-slate-200 " type="button">
          Add to bag
        </button>
      </div>
